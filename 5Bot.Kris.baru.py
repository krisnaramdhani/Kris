...
admin=["u31ef22df7f538df1d74dc7f756ef1a32","u9cc2323f5b84f9df880c33aa9f9e3ae1",mid,Amid,Bmid,Cmid,Dmid] #mid Krisna, mid kris,
...
#-------------------------------------------------------- 
        if op.type == 13:
            if mid in op.param3:
              if wait["autoJoin"] == True:
                if op.param2 in DEF or creator:
                  cl.acceptGroupInvitation(op.param1)
                else:
                  cl.rejectGroupInvitation(op.param1)
              else:
...
#--------------------------------------------------------
        if op.type == 19: 
          ...
          if induk in op.param3: #Admin ke Kick
